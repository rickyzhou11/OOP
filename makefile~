...
RunLife: AbstractCell.c++ AbstractCell.h Cell.h ConwayCell.c++ ConwayCell.h Handle.h Life.h RunLife.c++
	g++ -pedantic -std=c++0x -Wall AbstractCell.h ConwayCell.c++ RunLife.c++ -o RunLife
